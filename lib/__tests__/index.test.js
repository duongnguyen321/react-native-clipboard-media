...
describe('MediaClipboard', () => {
    ...
    it('should implement MediaClipboardInterface', () => {
        expect(MediaClipboard).toEqual(expect.objectContaining({
    ...
    describe('copyText', () => {
        it('should copy text to clipboard', async () => {
            ...
            expect(NativeModules.MediaClipboard.copyText).toHaveBeenCalledWith(testText);
        });
    });
    describe('copyImage', () => {
        it('should copy image to clipboard', async () => {
            ...
            const { NativeModules } = require('react-native');
            expect(NativeModules.MediaClipboard.copyImage).toHaveBeenCalledWith(imagePath, options);
        });
    });
    describe('copyVideo', () => {
        it('should copy video to clipboard', async () => {
            ...
            const { NativeModules } = require('react-native');
            expect(NativeModules.MediaClipboard.copyVideo).toHaveBeenCalledWith(videoPath, options);
        });
    });
    describe('copyPDF', () => {
        it('should copy PDF to clipboard', async () => {
            ...
            const { NativeModules } = require('react-native');
            expect(NativeModules.MediaClipboard.copyPDF).toHaveBeenCalledWith(pdfPath, options);
        });
    });
    describe('copyAudio', () => {
        it('should copy audio to clipboard', async () => {
            ...
            const { NativeModules } = require('react-native');
            expect(NativeModules.MediaClipboard.copyAudio).toHaveBeenCalledWith(audioPath, options);
        });
    });
    describe('copyFile', () => {
        it('should copy file to clipboard', async () => {
            ...
            const { NativeModules } = require('react-native');
            expect(NativeModules.MediaClipboard.copyFile).toHaveBeenCalledWith(filePath, mimeType, options);
        });
    });
    describe('hasContent', () => {
